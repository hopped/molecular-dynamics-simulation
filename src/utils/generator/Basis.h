...
void basis_addMolecule(basis_t* basis, generator_molecule_t molecule);
int basis_numMolecules(basis_t* basis);
generator_molecule_t basis_getMolecule(basis_t* basis, int i);
...
public:
	 ...
	 */
	void addMolecule(generator_molecule_t molecule);
	 ...
	 */
	generator_molecule_t getMolecule(int i);

private:
    std::vector<generator_molecule_t> _molecules;
};
